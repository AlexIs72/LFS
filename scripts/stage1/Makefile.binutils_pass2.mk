...
#	cd $(PKG_BUILD_DIR) && 
	...
	make -C $(PKG_BUILD_DIR)/ld clean && \
	make -C $(PKG_BUILD_DIR)/ld LIB_PATH=/usr/lib:/lib && \
	cp -v $(PKG_BUILD_DIR)/ld/ld-new /$(TOOLCHAIN_DIR_NAME)/bin
...
$(PKG_BUILD_DIR)/Makefile: $(PKG_SRC_DIR)
	...
	$(PKG_SRC_DIR)/configure                   \
	    ...
	    --disable-nls              \
	    --disable-werror           \
	    --with-lib-path=/$(TOOLCHAIN_DIR_NAME)/lib \
	    --with-sysroot
